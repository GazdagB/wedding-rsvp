...
const Navbar = () => {
  return (
    <nav className="fixed items-center flex justify-between top-0 left-1/2 transform -translate-x-1/2 bg-white py-10 w-[1200px]">
        {/* Menu */}
        ...
        <p className="logo absolute bottom-0 left-[50%] transform -translate-x-[30%] text-[20px]">
            Szeptember 7. 2025
        </p>
