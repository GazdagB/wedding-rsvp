    ...
    className="">
      <div className="w-full pt-50 flex flex-col  items-center justify-center">
          ...
          <div className="flex flex-col items-center mb-10">
              <div className="bg-wedding-champagne mb-3 flex items-center justify-center gap-3 text-wedding-brown-darker p-5 w-40 text-3xl font-semibold rounded-md text-center" ><FaUsers />

              {numbersIsLoading ? <ClipLoader  color="#52493D" loading={numbersIsLoading}/> :  guestNumbers.totalAttendees || "-"}</div>
              <p className="font-semibold text-2xl">Násznép</p>
            </div>
